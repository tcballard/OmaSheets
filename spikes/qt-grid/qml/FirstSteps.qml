...
Frame {
    ...
    readonly property var pages: [
        ...
        { title: "4. Share your work", body: "Use File → Export workbook as Excel to write a separate copy. Read the export report for any unsupported features. F1 brings back the full keyboard guide anytime.", row: 4, column: 3 }
    ]
